...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 font-weight-bold">Detail Struktur Organisasi</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('admin-user/dashboard') }}">Home</a></li>
          <li class="breadcrumb-item"><a href="{{ url('admin-user/menu/5') }}">Struktur Organisasi Ikasmandu 91</a></li>
      ...
      <div class="col-md-12">
        <div class="card card-success card-outline">
          <div class="card-header">
            <h3 class="card-title">Struktur Organisasi Ikasmandu 91</h3>
          </div>
          <div class="card-body">
            <form action="{{ url('admin-user/organisasi/ubah-struktur-kepengurusan/'. $struktur->id_sub_menu_5) }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="form-group row">
                ...
                <div class="col-sm-10 ">
                  <div class="btn btn-default btn-file">
                    ...
                    <input type="hidden" class="form-control" name="old_img" value="{{ $struktur->sm5_img }}"> 
                    <input type="file" class="form-control image" name="new_img"> 
                    <img id="preview-image-before-upload" src="{{ asset('images/main/structure/'. $struktur->sm5_img) }}" style="max-height: 80px;">
                  </div><br>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="summernote" name="text">{{ $struktur->sm5_text }}</textarea>
                </div>
              </div> -->
              <div class="form-group row">
