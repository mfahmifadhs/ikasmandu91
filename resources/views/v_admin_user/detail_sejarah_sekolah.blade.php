...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 font-weight-bold">Sejarah SMAN 2 Padang</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ url('admin-user/sekolah/ubah-sejarah-sman2-padang/'. $history->id_sub_menu_1) }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="form-group row">
                ...
                <div class="col-sm-10 ">
                  <div class="btn btn-default btn-file">
                    ...
                    <input type="hidden" class="form-control" name="old_img" value="{{ $history->sm1_img }}"> 
                    <input type="file" class="form-control image" name="new_img"> 
                    <img id="preview-image-before-upload" src="{{ asset('images/main/history/'. $history->sm1_img) }}" style="max-height: 80px;">
                  </div><br>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="summernote" name="text">{{ $history->sm1_text }}</textarea>
                </div>
              </div>
              <div class="form-group row">
