...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 font-weight-bold">Arsip Berita SMAN 2 Padang</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Arsip Berita SMAN 2 Padang</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
      ...
      <div class="col-md-9 form-group">
        <div class="row">
          ...
          <div class="col-md-2 form-group">
            ...
            <a href="{{ url('admin-user/berita/arsip/semua') }}" class="btn btn-success"><i class="fas fa-archive"></i></a>
